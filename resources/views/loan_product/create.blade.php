        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-md-3">
                            {!! Form::text('default_principal',null, array('class' => 'form-control ', 'placeholder'=>trans_choice('general.default',1) ,'required'=>'required')) !!}
                        </div>
                        <div class="col-md-3">
                            {!! Form::text('minimum_principal',null, array('class' => 'form-control ', 'placeholder'=>trans_choice('general.min',1),'required'=>'required')) !!}
                        </div>
                        <div class="col-md-3">
                            {!! Form::text('maximum_principal',null, array('class' => 'form-control', 'placeholder'=>trans_choice('general.max',1) ,'required'=>'required')) !!}
                        </div>
                        <div class="col-sm-3">
