...
@section('title'){{trans_choice('general.payment',1)}} {{trans_choice('general.report',2)}}
@endsection
@section('content')
    <div class="panel panel-white">
        <div class="panel-heading">
            <h6 class="panel-title">{{trans_choice('general.payment',1)}} {{trans_choice('general.report',2)}}</h6>
    ...
    !-->
                <tr>
                    <td>
                        <a href="{{url('report/financial_report/provisioning')}}">{{trans_choice('general.payment',1)}}</a>
                    </td>
        <!--
                    <td>
