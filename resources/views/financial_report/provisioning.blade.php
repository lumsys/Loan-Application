...
@section('title')
    {{trans_choice('general.payment',1)}} {{trans_choice('general.report',1)}}
@endsection
@section('content')
    ...
    @if(!empty($end_date))
        ...
        !-->
                    ...
                    <tr class="bg-green font-11">
                        ...
                        <th style="border: solid #ccc thin">{{trans_choice('general.bank',1)}}</th>
                        <th style="border: solid #ccc thin">{{trans_choice('Number',1)}}</th>
                        ...
                        <th style="border: solid #ccc thin">{{trans_choice('1% charge',1)}}</th>
            <!--
                        <th style="border: solid #ccc thin">{{trans_choice('charges',2)}}</th>
                    ...
                    session('branch_id'))->where('status', 'disbursed')->orderBy('release_date','asc')->get() as $key)
                       <?php
                        ...
                        if ($due > 0) {
                            ...
                            $schedules = \App\Models\LoanSchedule::where('loan_id', $key->id)->whereDate('due_date','<=',$end_date)->orderBy('due_date', 'asc')->get();
                                //dd($key);
