            ...
            <div class="panel  registration-form">
                <div class="panel-body">
                        ...
                        <div class="icon-object border-slate-300 text-slate-300">
                            @if(!empty(\App\Models\Setting::where('setting_key','company_logo')->first()->setting_value))
                               <!--
                                ...
                                !-->
                               <img src=" {{ asset('assets/themes/limitless/images/icslogo.jpg') }}"
                                     class="" height="72"/>
                            @else
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group ">
                                {!! Form::text('staff_id', null, array('class' => 'form-control', 'placeholder'=>trans_choice('Staff Id',1),'required'=>'required','id'=>'staff_id')) !!}
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="form-group ">
                                {!! Form::text('bvn', null, array('class' => 'form-control', 'placeholder'=>trans_choice('BVN',1),'required'=>'required','id'=>'bvn')) !!}
                            </div>
                        </div>

                        <div class="col-md-6">
                            <div class="form-group ">
                                {!! Form::number('total_salary', null, array('class' => 'form-control', 'placeholder'=>trans_choice('Monthly Salary',1),'required'=>'required','id'=>'total_salary')) !!}
                            </div>
                        </div>
                    </div>
                    <div class="row">
