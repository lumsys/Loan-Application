        ...
        <div class="panel-body table-responsive no-padding">
            ...
            <table class="table table-bordered table-condensed table-hover">
                ...
                <tr class="bg-green">
                    ...
                    <th>{{trans_choice('1% charges',2)}}</th>
                ...
                <tbody>
                <?php
                $chargess = \App\Models\Loan::where('status', 'disbursed')->sum('charges');      
             ?>
                <tr>
                    ...
                    <td>{{number_format($chargess,2)}}</td>
                    <td>{{number_format($due_items["penalty"],2)}}</td>
                    <td>{{number_format($due_items["principal"]+$due_items["interest"]+$due_items["fees"]+$due_items["penalty"]+$chargess,2)}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>{{number_format(($due_items["principal"]+$due_items["interest"]+$chargess+$due_items["penalty"])-($paid_items["principal"]+$paid_items["interest"]+$paid_items["fees"]+$paid_items["penalty"]),2)}}</td>
                </tr>
                </tbody>
            </table>
        </div>
