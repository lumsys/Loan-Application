...
@section('content')
    <div class="panel panel-white">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                {!! Form::label('account_Number',trans_choice('Account Number',1),array('class'=>'col-sm-3 control-label')) !!}
                <div class="col-sm-5">
                    {!! Form::text('account_Number',$application->account_number, array('class' => 'form-control', 'placeholder'=>"",'required'=>'required')) !!}
                </div>
                
            </div>

            <div class="form-group">
                {!! Form::label('decimal_places',trans_choice('general.bank',1),array('class'=>'col-sm-3 control-label')) !!}
                <div class="col-sm-5">
                <!--{!! Form::label('bank_account_id',trans_choice('bank',1),array('class'=>'')) !!}!-->
                {!! Form::text('bank',$application->bank, array('class' => 'form-control',  'placeholder'=>'','required'=>'required','id'=>'bank')) !!}
                </div>
            </div>

            <div class="form-group">
                {!! Form::label('decimal_places',trans_choice('Charges',1),array('class'=>'col-sm-3 control-label')) !!}
                <div class="col-sm-5">
                <!--{!! Form::label('bank_account_id',trans_choice('bank',1),array('class'=>'')) !!}!-->
                {!! Form::text('charge',$application->charges, array('class' => 'form-control',  'placeholder'=>'','required'=>'required','id'=>'charge')) !!}
                </div>
            </div>
