        ...
        <div style="width: 980px;height: 224px;margin-left: auto;margin-right: auto;border-top: solid thin rgba(2, 180, 209, 0.44);border-bottom: solid thin rgba(2, 180, 209, 0.44);padding: 20px;text-transform: capitalize">
            ...
            <div style="width: 300px;float: left">
               ...
               <!-- <b>{{trans_choice('general.fee',2)}}</b><span
                ...
                !-->
                <?php
                $chargess = \App\Models\Loan::where('id',$loan->id)->where('status', 'disbursed')->first();      
             ?>
              <b>{{trans_choice('1% charge',2)}}</b><span
              class="pull-right"> {{number_format($chargess->charges,2)}}</span><br><br>
                ...
                <b>{{trans_choice('general.due',1)}}</b><span class="pull-right"
                                style="">{{number_format(\App\Helpers\GeneralHelper::loan_total_due_amount($loan->id)+$chargess->charges,2)}}</span><br><br>
                ...
                <b>{{trans_choice('general.balance',1)}}</b><span class="pull-right"
                                    style="">{{number_format(\App\Helpers\GeneralHelper::loan_total_balance($loan->id)+$chargess->charges,2)}}</span><br><br>
            </div>
        </div>
