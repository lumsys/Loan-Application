            ...
            <div class="panel border-left-lg border-left-primary">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 form-horizontal">
                            <div class="form-group">
                                <label class="control-label col-md-4"><strong>{{trans_choice('general.age',1)}}
                                        :</strong></label>
                                <div class="col-md-8" style="padding-top: 9px;">
                                    @if(!empty($loan->borrower->dob))
                                     <p>{{$loan->borrower->dob}}</p>
                                    @endif
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-3 form-horizontal">
                            <div class="form-group">
                                <label class="control-label col-md-4"><strong>{{trans_choice('staff_id',1)}}
                                        :</strong></label>
                                <div class="col-md-8" style="padding-top: 9px;">
                                    <span>{{$loan->borrower->staff_id}}</span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-4"><strong>{{trans_choice('total_salary',1)}}
                                        :</strong></label>
                                <div class="col-md-8" style="padding-top: 9px;">
                                    <span>{{$loan->borrower->total_salary}}</span>
                                </div>
                            </div>
                            <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="table-responsive">
                                                    <table id="repayments-data-table"
                                                     ...
                                                     $chargess = \App\Models\Loan::where('id',$key->loan_id)->where('status', 'disbursed')->first();
                                                 
                                                      $balance = $balance + ($key->debit - $key->credit + $chargess->charges);
                                                            ?>
                                                            <tr>
                                                                <td>{{$key->id}}</td>
                                                                <td>{{$key->date}}</td>
                                                                ...
                                                                <td>
                                                                            ...
                                                                            {{number_format($chargess->charges,2)}}
                                ...
                                <div class="box box-success">
                                         ...
                                         !-->       
                                            ...
                                            <tr class="@if($overdue==1) danger  @endif @if($overdue==0 && $outstanding==0) success  @endif">
                                                ...
                                                <td style="text-align:right">
                                                     ...
                                                     @if($chargess->loan_product_id=='1')
                                                                            {{number_format($chargess->charges/3,2)}}
                                                                            @endif

                                                                            @if($chargess->loan_product_id=='2')
                                                                            {{number_format($chargess->charges/6,2)}}
                                                                            @endif
                                                    
                                                                            @if($chargess->loan_product_id=='3')
                                                                            {{number_format($chargess->charges/8,2)}}
                                                                            @endif

                                                                            @if($chargess->loan_product_id=='4')
                                                                            {{number_format($chargess->charges/12,2)}}
                                                                            @endif

                                                                            @if($chargess->loan_product_id=='5')
                                                                            {{number_format($chargess->charges/12,2)}}
                                                                            @endif
                                    ...
                                    !-->
                                                ...
                                                <td style="text-align:right; font-weight:bold">
                                                    {{number_format($due+$chargess->charges,2)}}
                                                </td>
                                                ...
                                                <td style="text-align:right;">
                                                    {{number_format($outstanding+$chargess->charges,2)}}
                                                </td>
                                                <!--
                                                <td style="text-align:right;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:right;">
                                               <b>     {{number_format(\App\Helpers\GeneralHelper::loan_total_principal($loan->id),2)}} </b>
                                                </td>
                                                <td style="text-align:right;">
                                                   <b> {{number_format(\App\Helpers\GeneralHelper::loan_total_interest($loan->id)-\App\Helpers\GeneralHelper::loan_total_interest_waived($loan->id),2)}} </b>
                                                </td>
                                    <!--
                                                <td style="text-align:right;">
                                    ...
                                    !-->
                                                <td style="text-align:right;">
                                                  ...
                                                  <b>  {{number_format($chargess->charges,2)}} </b>
                                                </td>
                                                <td style="text-align:right;">
                                                 <b>   {{number_format(\App\Helpers\GeneralHelper::loan_total_penalty($loan->id),2)}} </b>
                                                </td>
                                                <td style="text-align:right;">
                                                 <b>   {{number_format($total_due+$disbursement_charges+$chargess->charges,2)}} </b>
                                                </td>
                                                <td style="text-align:right;">
                                                  <b>  {{number_format($total_paid+$disbursement_charges,2)}} </b>
                                                </td>
                                                <td style="text-align:right;">
                                                 <b>   {{number_format(\App\Helpers\GeneralHelper::loan_total_balance($loan->id)+$chargess->charges,2)}} </b>
                                                </td>
                                                <td></td>
                                            </tr>
                                            </tbody>
                                    ...
                                    <table class="table table-bordered table-condensed">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:right">
                                                ...
                                                {{number_format(\App\Helpers\GeneralHelper::loan_total_fees($loan->id)+$chargess->charges,2)}}
                                            ...
                                            <td style="text-align:right; font-weight:bold">
                                                {{number_format(\App\Helpers\GeneralHelper::loan_total_due_amount($loan->id)+$chargess->charges,2)}}
                                            </td>
                                        </tr>
                                        <tr>
                        ...
                        <!--
                                ...
                                <!--
                                            <td style="text-align:right">
                                             ...
                                             <td style="text-align:right">
                                                {{number_format(\App\Helpers\GeneralHelper::loan_total_fees($loan->id)+$chargess->charges*3,2)}}
                                            </td>
                                            ...
                                            <td style="text-align:right; font-weight:bold">
                                                {{number_format((\App\Helpers\GeneralHelper::loan_total_due_amount($loan->id)-($loan_paid_items['principal']+$loan_paid_items['interest']+$loan_paid_items['penalty'])),2)}}

                                            </td>!-->
                                <!--
                                            <td style="text-align:right; font-weight:bold">
                                                {{number_format((\App\Helpers\GeneralHelper::loan_total_due_amount($loan->id)-($loan_paid_items['principal']+$loan_paid_items['interest']+$chargess->charges*3+$loan_paid_items['penalty'])),2)}}
